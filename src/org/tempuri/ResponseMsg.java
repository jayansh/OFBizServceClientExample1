...
public class ResponseMsg implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * ResponseMsg Namespace URI = http://tempuri.org/ Namespace Prefix = ns1
     */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ResponseMsg", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ResponseMsg", xmlWriter);
            }
        ...
        if (java.lang.Double.isNaN(localCurBalance)) {
            ...
            xmlWriter
                    .writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCurBalance));
        }
        ...
        if (java.lang.Double.isNaN(localAvlBalance)) {
            ...
            xmlWriter
                    .writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAvlBalance));
        }
        ...
        if (java.lang.Double.isNaN(localLoadAmount)) {
            ...
            xmlWriter
                    .writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLoadAmount));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localResponsestatusTracker) {
            elementList.add(new javax.xml.namespace.QName("http://tempuri.org/", "Responsestatus"));
        ...
        elementList.add(new javax.xml.namespace.QName("http://tempuri.org/", "CurBalance"));

        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCurBalance));

        elementList.add(new javax.xml.namespace.QName("http://tempuri.org/", "AvlBalance"));

        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAvlBalance));
        if (localAcknowledgementTracker) {
            elementList.add(new javax.xml.namespace.QName("http://tempuri.org/", "Acknowledgement"));
        ...
        elementList.add(new javax.xml.namespace.QName("http://tempuri.org/", "LoadAmount"));

        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLoadAmount));
        ...
        public static ResponseMsg parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ResponseMsg".equals(type)) {
                            ...
                            return (ResponseMsg) org.tempuri.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/", "Responsestatus")
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "Responsestatus" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setResponsestatus(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/", "CurBalance")
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "CurBalance" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setCurBalance(org.apache.axis2.databinding.utils.ConverterUtil.convertToDouble(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/", "AvlBalance")
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "AvlBalance" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setAvlBalance(org.apache.axis2.databinding.utils.ConverterUtil.convertToDouble(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/", "Acknowledgement")
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "Acknowledgement" + "  cannot be null");
                    }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/", "LoadAmount")
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "LoadAmount" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setLoadAmount(org.apache.axis2.databinding.utils.ConverterUtil.convertToDouble(content));
